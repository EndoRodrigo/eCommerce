...
public class Customer extends Person {
    ...
    public String getLegal_organization_id() { return legal_organization_id; }
    public void setLegal_organization_id(String legal_organization_id) { this.legal_organization_id = legal_organization_id; }

    public String getTribute_id() { return tribute_id; }
    public void setTribute_id(String tribute_id) { this.tribute_id = tribute_id; }

    public Integer getIdentification_document_id() { return identification_document_id; }
    public void setIdentification_document_id(Integer identification_document_id) { this.identification_document_id = identification_document_id; }

    public String getMunicipality_id() { return municipality_id; }
    public void setMunicipality_id(String municipality_id) { this.municipality_id = municipality_id; }
